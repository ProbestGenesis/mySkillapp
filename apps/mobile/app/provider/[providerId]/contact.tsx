            ...
            <View className="flex-col gap-2 pb-35">
              <View className="flex-col gap-1">
                ...
                <View className="w-full items-center">
                  <Text className="text-accent text-sm">Bio</Text>
                  <Text className="max-auto w-fit text-center text-sm">{data?.bio}</Text>
                </View>

                <View className="flex flex-col gap-2.5">
                  <Text className="text-accent text-lg">{`Selectionner une competence`}</Text>
                        ...
                        <Badge
                          ...
                          <Pressable onPress={() => setSelectedSkill(skill.id)}>
                            <Text
                              className={clsx(
                                'max-h-8 text-xs',
                                selectedSkill === skill.id ? 'text-white' : 'text-black'
                              )}>
